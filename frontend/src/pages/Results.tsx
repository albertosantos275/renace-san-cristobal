...
import { ChevronLeft, Users, Target, TrendingUp } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center pt-4">
          <Link to="/registro" className="btn-primary text-lg px-8 py-4 rounded-2xl inline-block font-bold">
            Únete al Censo
          </Link>
        </div>
      </div>
